/*Implementar un programa que solicite al usuario el ingreso de un signo del zodíaco de una lista de opciones 
y le muestre por pantalla un mensaje que indique si es de agua, aire, tierra, fuego o si ha seleccionado 
un valor inválido. Sugerencia: usar switch. Por ejemplo, si se ingresa el valor 1, mostrar “El signo de 
Aries es de Fuego”, si se ingresa 15 mostrar “El valor ingresado no corresponde a una opción válida”*/
